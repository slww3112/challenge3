    ...
    xhr.onload = function() {
        ...
        <div class="ref-quantity-col">
            <div class="ref-product-quantity">
				...
				<input type="text" id="item_count`+test[i][0]+`" value="`+test[i][1]+`">
        ...
        if ('<?php echo isset($_POST['btn_save']); ?>' != '') {
            <?php
            if (isset($_POST['btn_save']) != '') {
                ...
                if (!$link) {
                    ...
                    $sql = "select Type,coupon_value from coupon where coupon_code = 'test';";
            ...
            if ('<?php $applied ?>' != '') {
                ...
                document.getElementById('cart_table').style = 'pointer-events: none';
            }
            else {
